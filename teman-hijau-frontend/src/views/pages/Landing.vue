    ...
    <div class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div
                ...
                <a class="flex align-items-center w-full" href="#"> <img :src="logoUrl" alt="Sakai Logo" height="50"
                        class="mr-0 lg:mr-2" /><span class="text-900 font-medium text-2xl line-height-3 mr-8">Teman
                        Hijau</span> </a>
            ...
            <div id="articles" class="py-4 px-4 lg:px-8 my-2 md:my-4">
                <div class="text-center">
                    <h2 class="text-900 font-normal mb-2">Featured Articles</h2>
                    <span class="text-600 text-2xl">Amet consectetur adipiscing elit...</span>
                </div>

                <Carousel :value="[1,3,4,4,5]" :numVisible="3" :numScroll="3" :responsiveOptions="responsiveOptions" class="p-2">
                    <template #item="slotProps">
                        <div class="border-1 surface-border border-round m-2 text-center">
                            <div class="mb-3">
                                <img :src="'https://blocks.primevue.org/images/blocks/blog/blog-2.jpg'" alt="Article Image" class="w-full shadow-2" />
                            </div>
                            <div class="px-4 pt-2 pb-4">
                                <div class="text-left">
                                    <span class="block text-xl text-gray-900 font-smibold">Article Title</span>
                                </div>
                            </div>
                        </div>
                    </template>
